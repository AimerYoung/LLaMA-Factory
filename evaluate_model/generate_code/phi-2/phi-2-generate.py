...
model = AutoModelForCausalLM.from_pretrained("/home/zcl/LLaMA-Factory/saves/phi-2_2k/lora/sft/checkpoint-750", torch_dtype="auto", device_map="cuda", trust_remote_code=True)
tokenizer = AutoTokenizer.from_pretrained("/home/zcl/LLaMA-Factory/saves/phi-2_2k/lora/sft/checkpoint-750", trust_remote_code=True)
...
output_filename = "/home/zcl/LLaMA-Factory/evaluate_model/outputs/phi-2-lora-semantic/outputs_2k_test.json"
