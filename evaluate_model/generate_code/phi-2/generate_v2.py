...
model = AutoModelForCausalLM.from_pretrained("/home/zcl/LLaMA-Factory/saves/phi-2_3k/lora/sft/checkpoint-937", torch_dtype="auto", device_map="cuda", trust_remote_code=True)
tokenizer = AutoTokenizer.from_pretrained("/home/zcl/LLaMA-Factory/saves/phi-2_3k/lora/sft/checkpoint-937", trust_remote_code=True)
...
output_filename = "/home/zcl/LLaMA-Factory/evaluate_model/outputs/phi-2-lora-semantic/outputs_3k_test.json"
