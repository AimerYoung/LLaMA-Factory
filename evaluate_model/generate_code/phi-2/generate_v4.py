...
model = AutoModelForCausalLM.from_pretrained("/home/zcl/LLaMA-Factory/saves/phi-2_4k/lora/sft/checkpoint-1250", torch_dtype="auto", device_map="cuda", trust_remote_code=True)
tokenizer = AutoTokenizer.from_pretrained("/home/zcl/LLaMA-Factory/saves/phi-2_4k/lora/sft/checkpoint-1250", trust_remote_code=True)
...
output_filename = "/home/zcl/LLaMA-Factory/evaluate_model/outputs/phi-2-lora-semantic/outputs_4k_test.json"
