...
model = AutoModelForCausalLM.from_pretrained("/home/zcl/LLaMA-Factory/saves/qwen-1.5-7b-0.3lr/lora/sft/checkpoint-2910", torch_dtype="auto", device_map="cuda", trust_remote_code=True)
tokenizer = AutoTokenizer.from_pretrained("/home/zcl/LLaMA-Factory/saves/qwen-1.5-7b-0.3lr/lora/sft/checkpoint-2910", trust_remote_code=True)
...
output_filename = "/home/zcl/LLaMA-Factory/evaluate_model/outputs/qwen-1.5-lora-semantic/0.3lr_test.json"
